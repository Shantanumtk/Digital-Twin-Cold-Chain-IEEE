    ...
    >
      ...
      <div style={{ padding: "12px 16px 4px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <div style={{ fontSize: 10, color: theme.dim, marginTop: 1 }}>
            {isTruck ? (a.route || "No route") : (a.site || "No site")} · {a.cargo || a.asset_type}
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span style={{ fontSize: 9, color: theme.dim }}>{a.last_update || "—"}</span>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={m.l} style={{ textAlign: "center" }}>
            <div style={{ fontSize: 8, color: theme.dim, textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 2 }}>{m.l}</div>
